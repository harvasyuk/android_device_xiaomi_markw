...
# Release name
PRODUCT_RELEASE_NAME := Redmi 4
export TARGET_DEVICE := markw

# Inherit AOSP device configuration for markw.
$(call inherit-product, device/xiaomi/markw/aosp_markw.mk)
